(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("Popper"), require("jQuery"));
	else if(typeof define === 'function' && define.amd)
		define(["Popper", "jQuery"], factory);
	else {
		var a = typeof exports === 'object' ? factory(require("Popper"), require("jQuery")) : factory(root["Popper"], root["jQuery"]);
		for(var i in a) (typeof exports === 'object' ? exports : root)[i] = a[i];
	}
})(self, function(__WEBPACK_EXTERNAL_MODULE_popper_js__, __WEBPACK_EXTERNAL_MODULE_jquery__) {
...
__webpack_require__(/*! ../scss/app.scss */ "./resources/scss/app.scss");

/*
  Add custom scripts here
*/
__webpack_require__.g.$ = __webpack_require__.g.jQuery = __webpack_require__(/*! jquery */ "jquery");
__webpack_require__(/*! popper.js */ "popper.js");
...
__webpack_require__.g.NProgress = __webpack_require__(/*! nprogress */ "./node_modules/nprogress/nprogress.js");
var $body = $('body');
$body.removeClass('preload'); // To prevent CSS transition on page load

$body.on('change', 'select[data-fetch-child=true]', function (e) {
  var $parentOption = $(e.currentTarget);
  var targetSelector = $parentOption.attr('data-fetch-target');
  var fetchUrl = $parentOption.attr('data-fetch-url');
  var paramName = $parentOption.attr('data-fetch-param-name');
  if (paramName === undefined) {
    paramName = $parentOption.attr('name');
  }
  var $targetElement = $(targetSelector);
  var firstOptionHtml = $targetElement.find('option:first-child')[0].outerHTML;
  var submitData = {};
  submitData[paramName] = $parentOption.val();
  $.get(fetchUrl, submitData).done(function (data) {
    var htmlOptions = Object.keys(data).map(function (key) {
      return "<option value=\"".concat(key, "\">").concat(data[key], "</option>");
    });
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/app"], function() { return __webpack_require__("./resources/js/app.js"); })
